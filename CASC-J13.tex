...
\end{cases}
\]
The progress values for systems that had 0\% loss in both years when $Solved = Solns$, indicated 
by a `-' in the $\Delta$~Loss column, are not directly comparable with the others, but do measure ``progress''.

There are very definite signs of progress, partiularly in the FOF division.
Drodi's improvement is salient, with iProver also having significant improvement (also in UEQ).
E is noteworthy for having consistently minimal loss, coupled with improved performance.
As an overall measure, in \LAST{} 459 of the 3961 proofs, i.e.,~11.5\%, from the THF, FOF, and 
UEQ divisions had syntax or structural flaws.
...
\hline
Division    & \LAST{}  &Problems&       &         & \THIS{} &Problems&       &        & $\Delta$ Loss &Progress \\
...
ProoVer~2026 was organized by Julie Cailler and Simon Guilloud.
...
However, 9 proofs were later removed as ambiguous or non-compliant, leaving 91 -- 44~good and
47~bad -- that were used for the ranking. 
...
Table~\ref{ProoVerSummary} lists the entrants, and Table~\ref{Results-Table} shows the results. 
...
\begin{table*}[tbh]
\caption{ProoVer 2026 entrants.}
\label{ProoVerSummary}
\begin{tabular}{ll}
\hline
Verifier          & Entrants \\
\hline
\multicolumn{2}{c}{\textit{Regular division}} \\
\hline
...
\hline
\multicolumn{2}{c}{Demonstration division} \\
\hline
...
\begin{table}[tbhp]
\caption{Proover 2026 scores}
\label{Results-Table}
\begin{tabular}{l|rrrr|rrrr|r}
\hline
                  &\multicolumn{4}{c|}{44 Good proofs}& \multicolumn{4}{c|}{47 Bad proofs} & Score \\
 \hline
Verifier          & VSG & VSB & UNK &   /44 & VSB & VSG & UNK & /94 & /138 \\
\hline
GAPT~2.20         &  34 &   5 &   5 &    29 &  41 &   0 &   6 &  82 &  111 \\
VaLeaDate~0.1     &  24 &  18 &   2 &     6 &  46 &   0 &   1 &  92 &   98 \\
N\"orgler~1.1     &  27 &  16 &   1 &    11 &  46 &   1 &   0 &  82 &   93 \\
ProofCheck~1.0    &  31 &  10 &   3 &    21 &  42 &   3 &   2 &  54 &   75 \\
ProofGuard~1.0    &  30 &  11 &   3 &    19 &  40 &   5 &   2 &  30 &   49 \\
mrs-proover~0.2.0 &  31 &  12 &   1 &    19 &  39 &   5 &   3 &  28 &   47 \\
PyCheck~1.0       &  37 &   2 &   5 &    35 &  28 &   5 &  14 &   6 &   41 \\
CheckProof~0.1    &  28 &  11 &   5 &    17 &  25 &  17 &   5 &-120 & -103 \\
\hline
\multicolumn{8}{c}{\textit{Demonstration division}} \\
\hline
GDV~2.0           &  35 &   5 &   4 &    30 &   8 &   5 &  34 & -34 &   -4 \\
GDV-LP~2.0        &  33 &   5 &   6 &    28 &   8 &   5 &  34 & -34 &   -6 \\
\hline
\end{tabular}
\end{table}
