...
\item Proofs must be syntactically correct in TPTP format~\cite{Sut07-CSR}.
      Proof syntax is checked using TPTP4X~\cite{Sut10}.
...
iProver had eight proofs with a granularity of over 1000, three of which were over 10000, and with
...
The impact was interesting, and data in the \LAST{} report showed that the ATP systems still 
needed to improve their proof output.
